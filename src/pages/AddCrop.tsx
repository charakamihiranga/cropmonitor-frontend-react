...
interface AddCropProps{
    ...
    onSave: (newCrop: Crop) => void;
}

function AddCrop({isModalOpen, setIsOpenModal, onSave }: Readonly<AddCropProps>) {
    ...
    function handleSave() {
        const newCrop = new Crop(
            formData.cropCommonName,
            formData.cropScientificName,
            formData.cropCategory,
            formData.cropSeason,
            fields.find((field) => field.fieldCode === formData.allocatedFieldCode)!,
            formData.cropImage
        );
        onSave(newCrop);
    ...
    return (
        isModalOpen && (
            ...
            >
                ...
                >
                    <h1 className="text-center text-xl font-semibold mb-8">Add Crop</h1>
                    <div className="overflow-y-auto h-[56vh] p-4">
