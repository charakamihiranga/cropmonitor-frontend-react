...
function UpdateEquipment({isModalOpen, setIsModalOpen, onUpdate, equipment }: Readonly<UpdateEquipmentProps>) {
    ...
    return (
        isModalOpen && (
            ...
            >
                ...
                >
                    <h1 className="text-center text-xl font-semibold mb-5">Update Equipment</h1>
